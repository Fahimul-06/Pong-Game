...
public class Paddle extends Rectangle {
    ...
    public void keyReleased(KeyEvent e) {
        switch(id) {
            case 1 -> {
                if(e.getKeyCode() == KeyEvent.VK_W || e.getKeyCode() == KeyEvent.VK_S) setYDirection(0);
            }
            case 2 -> {
                if(e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == KeyEvent.VK_DOWN) setYDirection(0);
            }
        }
    }
    ...
    public void checkBounds(int gameHeight) {
        if(y <= 0) y = 0;
